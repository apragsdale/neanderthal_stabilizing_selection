...
tar = tarfile.open(f"window_ancestry_data.SD_{SD}.mu_0.01.tar.gz")
...
fig.suptitle(f"Stabilizing selection, with $\\sigma_M={SD}$, $\\mu={0.01}$", fontsize=8, y=0.98)
fig.tight_layout()
fig.subplots_adjust(top=0.91)
plt.savefig(f"../figures/introgression_deserts.SD_{SD}.pdf")
#plt.show()
