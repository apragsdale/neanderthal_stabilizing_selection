...
intermediate frequencies due to heterosis \citep{harris2016genetic}. Despite
some documented cases of adaptive introgression, most introduced functional
alleles likely were selected against in humans \citep{harris2016genetic,
...
deleterious variation at an increased rate \citep{kimura1963mutation,
...
functional alleles were selected against \citep{sankararaman2014genomic,
...
\citep{sankararaman2014genomic, vernot2014resurrecting,
...
\citep{petr2019limits, telis2020selection, yermakovich2023long,
...
concurrent work, \citet{veller2024stabilizing} demonstrate this effect by
deriving the expected decay of minor parental ancestry under stabilizing
selection after admixture.  This prediction contrasts with the
...
\citep{castellano2014patterns,petr2019limits,petr2020evolutionary}.
...
\citep{lande1975maintenance, simons2018population}. Thus, only genetic effects
...
SI, Section~\ref{sec:underdominance}).
...
Information, Section~\ref{sec:underdominance}.

\begin{figure}[tb!]
    \centering
    \includegraphics{one_pop.pdf}
    \caption{
...
\begin{figure}[tb!]
    \centering
    \includegraphics{reciprocal_admixture.pdf}
    \caption{
...
algebra (SI, Section~\ref{sec:VG-admixture}), we can write the expected genetic
...
\begin{figure}[ht!]
    \centering
    \includegraphics{h2-per-SNP.pdf}
    \caption{
...
\begin{figure}[ht!]
    \centering
    \includegraphics{ancestry_reduction.pdf}
    \caption{
...
\begin{figure}[ht!]
    \centering
    \includegraphics{introgression_deserts.SD_0.02.pdf}
    \caption{
...
BDMI alleles being unlinked \citep{presgraves2003fine, li2022imbalanced} and an
...
selection coefficient $s$ (SI, Section~\ref{sec:moments-underdominance}). The
...
\citep{tennessen2012evolution}, individual-based forward-in-time simulations
...
outlined in SI, Section~\ref{sec:underdominance} (without taking the
...
\textbf{Supporting Information.} The Supporting Information file contains
supporting information text and figures, which are referenced in the main text.
