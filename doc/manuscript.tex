...
\begin{abstract}
    ...
    traits and trait architectures under stabilizing selection have been
...
\begin{quote}
    ...
    introgressed-ancestry deserts should be correlated between populations when
    there is bi-directional gene flow, as inferred between Neanderthals and
    humans.
...
most introduced functional alleles likely were selected against in humans
